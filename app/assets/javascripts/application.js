...
function checklist_behaviour(statuses){
   ...
   console.log(checklist_statuses_json);
   jQuery(function() {
...
function listTrClick(selector){
   jQuery(selector+" .issue_tr").click(function(){
...
function radio_button_behaviour(selector){
   ...
   if(jQuery.inArray(jQuery(selector).val(), ary) == -1) jQuery(id).show();
   else{
      jQuery(id).hide();
      jQuery(id+" input").val();
   }
