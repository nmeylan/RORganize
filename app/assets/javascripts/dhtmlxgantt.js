...
window.dhtmlx || (dhtmlx = function (t) {
    ...
    if (t.type == gantt.config.links.start_to_start)this.point_to(s.left, r), o ? (this.point_to(s.down, i), this.point_to(s.right, a)) : (this.point_to(s.right, a), this.point_to(s.down, i)), this.point_to(s.right, r); else if (t.type == gantt.config.links.finish_to_start)if (o = e.e_x > e.x + 2 * r, this.point_to(s.right, r), o)a -= r, this.point_to(s.down, i), this.point_to(s.right, a); else {
        a -= 2 * r;
        var d = i > 0 ? 1 : -1;
    ...
    for (var e = this._branches[t.parent], n = !1, i = 0, a = e.length; a > i; i++)if (e[i] == t.id) {
        n = !0;
        break
    }
    ...
    ]}, drag_lightbox: !0, sort: !1, details_on_create: !0, details_on_dblclick: !0, initial_scroll: !0, task_scroll_offset: 100, task_height: "full", min_column_width: 50}), gantt.keys = {edit_save: 13, edit_cancel: 27}, gantt._init_template = function (t, e) {
